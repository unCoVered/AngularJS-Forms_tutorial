...
import cursoangularjs.dominio.Sexo;
...
public class SeguroMedicoDAOImplementor implements SeguroMedicoDAO {

    @Override
    public void insert(SeguroMedico seguroMedico) throws BusinessException
    {
        ...
        try {
            ...
            PreparedStatement preparedStatement = connection.prepareStatement("INSERT INTO `seguromedico` (`nif`, " +
                    "`nombre`, `ape1`, `edad`, `sexo`, `casado`, `numhijos`, `embarazada`, `coberturaoftalmologica`, " +
                    "`coberturadental`, `coberturafecundacioninvitro`, `enfermedadcorazon`, `enfermedadestomacal`, " +
                    "`enfermedadrinyones`, `enfermedadalergia`, `nombrealergia`) " +
                    "VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)");
    ...
    @Override
    public void update(int idSeguroMedico, SeguroMedico seguroMedico) throws BusinessException {
    ...
    @Override
    public SeguroMedico get(int idSeguroMedico) throws BusinessException {
        Connection connection = null;
    ...
    @Override
    public void delete(int idSeguroMedico) throws BusinessException {
    ...
    @Override
    public List<SeguroMedico> findAll() throws BusinessException {
        Connection connection = null;
